...
int main()
{
        colossal::job_generator gen(0.01, 5, 5, 2, 80, 30, 0.7, 0.6, 1);
        gen.seed(time(NULL));
        colossal::job j1 = gen();

        colossal::job_generator gen1(0.1, 6, 3, 80, 30, 0.2, 0.5, 1, 1);
	...
	pools.push_back(colossal::pool("modeling", 2, 200, 1, 10, 10, colossal::pool::SCHED_FCFS));
