...
int main()
{
        colossal::job_generator gen(0.01, 5000, 2000, 80, 0.7, 3000, 2000, 300, 100);
        gen.seed(time(NULL));
        colossal::job j1 = gen();

        colossal::job_generator gen1(0.1, 20, 20, 80, 0.7, 0.8, 20, 20, 100);
	...
	pools.push_back(colossal::pool("modeling", 200, 200, 1, 10, 10, colossal::pool::SCHED_FAIR));
